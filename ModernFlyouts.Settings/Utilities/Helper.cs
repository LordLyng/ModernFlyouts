...
namespace ModernFlyouts.Settings.Utilities
{
    public static class Helper
    {
        ...
        {
            var result = false;
            var processes = Process.GetProcessesByName("ModernFlyouts");
        ...
        {
            var path = FileSystem.Path.Combine(LocalApplicationDataFolder(), $"Microsoft\\ModernFlyouts\\{moduleName}");
        ...
        public static string GetModernFlyoutsInstallationFolder()
        {
