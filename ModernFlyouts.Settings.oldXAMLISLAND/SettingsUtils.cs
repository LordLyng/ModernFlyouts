...
namespace ModernFlyouts.Settings
{
    public class SettingsUtils : ISettingsUtils
    {
        ...
        private T GetFile<T>(string powertoyFolderName = DefaultModuleName, string fileName = DefaultFileName)
        {
            ...
            // Look at issue https://github.com/microsoft/ModernFlyouts/issues/6413 you'll see the file has a large sum of \0 to fill up a 4096 byte buffer for writing to disk
